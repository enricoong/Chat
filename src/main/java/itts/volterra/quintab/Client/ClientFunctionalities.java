...
public class ClientFunctionalities {
   ...
   /**
    * Si connette al server, effettua lo scambio Diffie-Hellman e genera la chiave AES
    *
    * @param serverIP IP a cui connettersi
    * @return True se non ci sono stati errori
    */
   public boolean initializeConnection(String serverIP) {
      int connectionResult = connectToServer(serverIP, 12345); //mi connetto al client
      boolean error = false;
